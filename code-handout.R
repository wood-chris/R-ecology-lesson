...
## ggplot(data = portal_diplo, aes(x = species_id, y = weight)) +
...
## Challenge
## Based on printing `surveys` and the the output of `str(surveys)`, can you answer the following questions?
## * What are are the classes of the object `surveys`?
